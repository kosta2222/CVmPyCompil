...
class LabeledExprVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LabeledExprParser#init.
    def visitInit(self, ctx:LabeledExprParser.InitContext):
    ...
    # Visit a parse tree produced by LabeledExprParser#toExpr.
    def visitToExpr(self, ctx:LabeledExprParser.ToExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LabeledExprParser#toPrint.
    def visitToPrint(self, ctx:LabeledExprParser.ToPrintContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LabeledExprParser#toDef.
    def visitToDef(self, ctx:LabeledExprParser.ToDefContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LabeledExprParser#toSuite.
    def visitToSuite(self, ctx:LabeledExprParser.ToSuiteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LabeledExprParser#toEndFunc.
    def visitToEndFunc(self, ctx:LabeledExprParser.ToEndFuncContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LabeledExprParser#toTochka.
    def visitToTochka(self, ctx:LabeledExprParser.ToTochkaContext):
        return self.visitChildren(ctx)
